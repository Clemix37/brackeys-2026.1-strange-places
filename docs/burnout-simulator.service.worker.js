...
/** @type {string} */
const CACHE_VERSION = "1771693539|1473205105";
/** @type {string} */
const CACHE_PREFIX = "brackeys-2026.1--sw-cache-";
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = "burnout-simulator.offline.html";
/** @type {boolean} */
...
const CACHED_FILES = [
	"index.html",
	"burnout-simulator.js",
	"burnout-simulator.offline.html",
	"burnout-simulator.icon.png",
	"burnout-simulator.apple-touch-icon.png",
	"burnout-simulator.audio.worklet.js",
	"burnout-simulator.audio.position.worklet.js",
];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["burnout-simulator.wasm", "burnout-simulator.pck"];
...
self.addEventListener(
	...
	(event) => {
		...
		const isCacheable =
			FULL_CACHE.some((v) => v === local) || (base === referrer && base.endsWith(CACHED_FILES[0]));
